...
This repository was created for the replication of the results of the paper: 

> Valença, G.; Moura, F.; Morais de Sá. A. _Using text mining in systematic literature reviews: 
Methodology proposal and application to road space allocation._ Paper submitted to Communications in Transportation Research. 2022.   

Additionally, the code presented in this repository can be adapted and is reproducible to perform other literature reviews. This repository also provides guidelines to use text mining in literature reviews.   

If you use any of the material in this repository, **please cite the reference above**. 
...
* [Specific Paper Analysis](/Scripts/LDA R script.R)
